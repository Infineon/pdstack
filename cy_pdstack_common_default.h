/***************************************************************************//**
* \file cy_pdstack_common_default.h
* \version 4.0
*
...
#if !defined(CY_PDSTACK_COMMON_DEFAULT_H)
#define CY_PDSTACK_COMMON_DEFAULT_H
...
#ifndef CY_PD_REV3_FEATURE_CTRL
#define CY_PD_REV3_FEATURE_CTRL          (0u)
#endif /* CY_PD_REV3_FEATURE_CTRL */

/* DCY_PD_REV3_FEATURE_CTRL_INIT macro is required to only initialize dpmCtrlFlags
 * for CCG8x and to reduce the overall footprint of the stack by not defining CY_PD_REV3_FEATURE_CTRL. 
 * DCY_PD_REV3_FEATURE_CTRL_INIT is defined in Makefile. 
 * For other projects ex. CFP, this macro is mapped to CY_PD_REV3_FEATURE_CTRL to initialize dpmCtrlFlags
 */
#ifndef CY_PD_REV3_FEATURE_CTRL_INIT
#define CY_PD_REV3_FEATURE_CTRL_INIT     (CY_PD_REV3_FEATURE_CTRL)
#endif /* CY_PD_REV3_FEATURE_CTRL_INIT */

#ifndef CY_PD_EPR_CABLE_DEBUG_SIMULATION
#define CY_PD_EPR_CABLE_DEBUG_SIMULATION (0u)
#endif /* CY_PD_EPR_CABLE_DEBUG_SIMULATION */

#ifndef CY_PD_DEBUG_ACC_DISABLE
#define CY_PD_DEBUG_ACC_DISABLE          (0u)
#endif /* CY_PD_DEBUG_ACC_DISABLE */

#ifndef CY_PD_VDM_DISABLE
#define CY_PD_VDM_DISABLE                (0u)
...
#define CY_PDSTACK_MW_VERSION_MAJOR               (4)
...
#define CY_PD_VCONN_ON_TIMER_PERIOD            (150u)
...
#define CY_PD_FIX_SRC_PDO_MASK_REV3                (0xFFBFFFFFu)
...
/**
 * @typedef typec_fsm_evt_t.
 * @brief Enum to hold Type-C events ID.
 */
typedef enum
{
...
/**
 * @typedef pe_fsm_evt_t
 * @brief Enum to hold Policy engine events id
 */
typedef enum {
...
typedef enum
{
    ...
    CY_PDSTACK_APDO_AVS,                           /**< EPR AVS PDO. */
    CY_PDSTACK_APDO_SPR_AVS,                       /**< SPR AVS PDO. */
...
#endif /* (!(CY_PD_SINK_ONLY)) */
    CY_PDSTACK_TYPEC_FSM_CORROSION_MITIGATION,     /**< Corrosion Mitigation state. */
#if (!(CY_PD_DEBUG_ACC_DISABLE))
...
typedef enum
{
    ...
    APP_EVT_CORROSION_FAULT,                    /**< 0x54: Corrosion Mitigation Fault. */
    APP_TOTAL_EVENTS                            /**< 0x55: Total number of application events. */
...
/** @cond DOXYGEN_HIDE */
CY_MISRA_DEVIATE_BLOCK_START('MISRA C-2012 Rule 5.7', 1, 'Silicon specific common header file, guarded under silicon specific macro');
/** @endcond */
...
/** @cond DOXYGEN_HIDE */
CY_MISRA_BLOCK_END('MISRA C-2012 Rule 5.7');
/** @endcond */
...
/**
 * @brief Structure to hold device policy manager control flags.
 */
typedef union
{
...
}cy_stc_pdstack_dpm_ctrl_flags_t;
...
#endif /* CY_PDSTACK_COMMON_DEFAULT_H */
